...
const FIXTURE_JSON: &str = include_str!("../../../../testdata/deltrel/completion-bounds-v1.json");
...
fn shared_typescript_vectors_match_native_bounds() {
    ...
    assert_eq!(fixture.schema, "deltrel.completion-bounds.v1");
    ...
    for case in fixture.cases {
        ...
        for expected in case.scenarios {
            ...
            assert_eq!(
                scenario.score.players.map(|score| score.capes),
                expected.capes,
                "{}",
                case.id
            );
