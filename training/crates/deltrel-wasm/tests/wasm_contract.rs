...
const RULES_HASH: u64 = 0x46e4_fbcf_f4e1_7fd3;
...
fn wasm_state_matches_v3_contract_and_nodes_only_layout() {
    ...
    assert_eq!(WasmState::rules_hash_tag(), "fnv1a64:46e4fbcff4e17fd3");
    assert_eq!(WasmState::rules_schema(), "deltrel.rules.v3");
