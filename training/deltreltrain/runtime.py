...
CHAMPION_WARM_START_FORMAT = "deltreltrain.champion-warm-start"
CHAMPION_WARM_START_SCHEMA_VERSION = 1
CUTOVER_STAGING_FORMAT = "deltreltrain.cutover-staging"
CUTOVER_STAGING_SCHEMA_VERSION = 1
SELECTION_CUTOVER_FORMAT = "deltreltrain.selection-cutover"
