...
from .model import MODEL_SCHEMA_VERSION, GraphResTNet, ModelConfig, DeltrelModelOutput
from .replay import (
    ReplayBatch,
    ReplaySample,
    augment_sample,
...
BROWSER_MANIFEST_FORMAT = "deltreltrain.browser-model"
...
def _teacher_kl_losses(
    student: DeltrelModelOutput,
    teacher: DeltrelModelOutput,
    *,
