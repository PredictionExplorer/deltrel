...
The semantic key is the exact Python form of ``deltrel_engine::StateKey``: board,
...
from .topology import MAX_RINGS, DeltrelTopology, get_topology
...
class DoubleDeltrelPosition:
    """Exact Python form of ``deltrel_engine::StateKey`` plus evaluation context.
    ...
    def with_stones(self, stones: Tensor) -> "DoubleDeltrelPosition":
