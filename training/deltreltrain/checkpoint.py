...
CHECKPOINT_FORMAT = "deltreltrain.checkpoint"
CHECKPOINT_VERSION = 3
EMA_VERSION = 1
# Checkpoints of the previous lineage (rules v2, feature schema v3).
LEGACY_MODEL_SCHEMA_VERSION = 2
MODEL_MANIFEST_FORMAT = "deltreltrain.model-manifest"
MODEL_POINTER_FORMAT = "deltreltrain.model-pointer"
MODEL_MANIFEST_VERSION = 3
MODEL_POINTER_VERSION = 2
RECOVERY_POINTER_FORMAT = "deltreltrain.recovery-pointer"
RECOVERY_POINTER_VERSION = 1
RESUME_CUTOVER_FORMAT = "deltreltrain.resume-cutover"
...
def load_legacy_ema_checkpoint(
    ...
    *,
    ...
    if not isinstance(payload, dict) or payload.get("format") != CHECKPOINT_FORMAT:
        raise ValueError("not a deltreltrain checkpoint")
