...
RULES_SCHEMA_ID = "deltrel.rules.v3"
CONFORMANCE_SCHEMA_ID = "deltrel.conformance.v3"
ACTION_LAYOUT_SCHEMA_ID = "deltrel.action-layout.nodes-only.v1"
EXTERNAL_FEATURE_SCHEMA_ID = "deltrel.model-features.external.v3"
RULES_VERSION = 3
RULES_HASH_ALGORITHM = "fnv1a64"
RULES_HASH_HEX = "46e4fbcff4e17fd3"
...
LEGACY_RULES_SCHEMA_ID = "deltrel.rules.v2"
...
LEGACY_FEATURE_CONTRACT = (
    ...
    "terminal,current-score,opponent-score,margin,current-shores,"
    "opponent-shores,current-capes,opponent-capes,current-networks,"
    "opponent-networks,contested-shores;"
    "edges=tangential,radial-diagonal,bridge;"
    "sample-actions=node[0:N];"
    "batch-actions=node[0:maxN];"
    "soft-policy=katago-temperature-4"
