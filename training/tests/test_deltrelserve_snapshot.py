...
from deltrelserve.config import load_server_config
from deltrelserve.snapshot import ChampionSnapshotError, export_champion_snapshot
...
def test_champion_snapshot_relocates_verifies_hash_and_refuses_unsafe_inputs(
    ...
    copied_config = load_server_config(destination / "deltrelserve-mac.yaml")
    ...
    relocated_config = load_server_config(relocated / "deltrelserve-mac.yaml")
