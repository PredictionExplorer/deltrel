...
import deltrelserve.runtime as runtime_module
...
from deltreltrain.inference_batching import CohortInferenceAdapter
from test_inference_efficiency import ObservedNetwork, encoded_requests, position
from test_deltrelserve import request_payload, server_config
...
def test_server_batches_concurrent_callers_and_routes_each_result(model_manager):
    ...
    with manager.lease() as lease:
        ...
        assert models[0].threads == ["deltrel-inference-owner"]
