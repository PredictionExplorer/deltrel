  ...
  return (
    ...
    >
      <div className="thin-scroll panel-surface max-h-[calc(100dvh-1rem)] w-full overflow-y-auto rounded-[1.75rem] p-5 text-center shadow-[0_0_90px_rgba(232,196,139,0.2)] sm:p-8">
        <div className="pop-in mx-auto mb-3 flex h-14 w-14 items-center justify-center rounded-full border border-sand/50 bg-sand-faint">
          <ShieldCheck className="h-7 w-7 text-sand-strong" aria-hidden />
        </div>
        <p className="fade-in text-xs font-semibold uppercase tracking-[0.18em] text-sand">
          Result clinched
        </p>
        ...
        <div className="fade-up mx-auto mt-5 max-w-md rounded-2xl border border-sand/25 bg-sand-faint px-4 py-3 text-left">
        ...
        <div className="sticky bottom-0 z-10 -mx-2 mt-5 grid grid-cols-2 gap-2 rounded-2xl bg-estuary-surface-strong/95 px-2 py-3 backdrop-blur-md sm:grid-cols-3">
          <button
            ref={continueButton}
            type="button"
            onClick={onContinue}
            className="flex min-h-11 items-center justify-center rounded-xl border border-white/15 px-3 py-2 text-sm text-ink transition-colors hover:border-sand/50"
          >
            Continue playing
          </button>
          <button
            type="button"
            onClick={onProof}
            className="flex min-h-11 items-center justify-center gap-2 rounded-xl border border-white/20 px-3 py-2 text-sm text-ink transition-colors hover:border-sand/50 hover:bg-white/[0.04]"
          >
          ...
          <button
            type="button"
            onClick={onEnd}
            className="col-span-2 flex min-h-11 items-center justify-center gap-2 rounded-xl border border-sand/60 bg-sand-faint px-3 py-2 text-sm font-medium text-sand-strong transition-colors hover:bg-sand/25 sm:col-span-1"
          >
      ...
      <div className="panel-surface w-full rounded-3xl p-5 text-center shadow-[0_0_70px_rgba(0,0,0,0.35)] sm:p-7">
        <div
          className={`mx-auto mb-3 flex h-12 w-12 items-center justify-center rounded-full border ${
            destructive
              ...
              : 'border-sand/45 bg-sand-faint text-sand-strong'
          }`}
        >
        ...
        <div className="mt-6 grid gap-2 sm:grid-cols-2">
          <button
            ...
            type="button"
            onClick={onCancel}
            className="min-h-11 rounded-xl border border-white/15 px-4 py-2 text-sm text-ink transition-colors hover:border-sand/50"
          >
            Keep playing
          </button>
          <button
            ...
            className={`min-h-11 rounded-xl border px-4 py-2 text-sm font-medium transition-colors ${
              destructive
                ...
                : 'border-sand/60 bg-sand-faint text-sand-strong hover:bg-sand/25'
            }`}
          >
            {confirmLabel}
          </button>
